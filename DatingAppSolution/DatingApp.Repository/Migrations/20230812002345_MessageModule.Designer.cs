...
namespace DatingApp.Repository.Migrations
{
    ...
    [Migration("20230812002345_MessageModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp.Core.Entities.Messages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatingApp.Core.Entities.Messages", b =>
                {
                    b.HasOne("DatingApp.Core.Entities.AppUser", "Recipient")
                        .WithMany("MessagesRecieved")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DatingApp.Core.Entities.AppUser", "Sender")
